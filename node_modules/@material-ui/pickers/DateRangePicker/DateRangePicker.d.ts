...
export interface BaseDateRangePickerProps extends ExportedDateRangePickerViewProps, ValidationProps<DateRangeValidationError, RangeInput>, ExportedDateRangePickerInputProps {
    /**
...
declare type RangePickerComponent<TWrapper extends SomeWrapper> = <TDate>(props: BaseDateRangePickerProps & ExtendWrapper<TWrapper> & AllSharedDateRangePickerProps<TDate> & React.RefAttributes<HTMLDivElement>) => JSX.Element;
export declare const useDateRangeValidation: (value: RangeInput<unknown>, props: BaseDateRangePickerProps) => DateRangeValidationError;
